...
export default function TestCard({isDark, correct, incorrect, title}: TestCardProps) {
    return (

        <div className={`hover:scale-[1.01] transition-all ${isDark ? 'border-white/20' : 'border-gray-200 bg-white hover:bg-gray-50'}`}>
            <h1>{title}</h1>
        </div>
